(() => {
  ...
  const ASSET_VERSION = '20260906-reference-logo-2';
  const BRAND_LOGO = `/assets/brand/orbiwest-header-reference.png?v=${ASSET_VERSION}`;
  ...
  function logoImg(className, alt = 'Orbiwest Technologies') {
    return `<img class="${className}" src="${BRAND_LOGO}" width="515" height="115" alt="${alt}">`;
  }
